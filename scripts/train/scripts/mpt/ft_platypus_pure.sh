...
PRECISION="amp_bf16"
export RUN_NAME="pure_sparse_finetuning_40sp_"${MODEL_NAME_OR_PATH}"_"${MAX_DURATION}"_batch_"${GLOBAL_TRAIN_BATCH_SIZE}"_LR_"${LR}
...
composer train_sparse_KD_pure.py yamls/finetune/mpt/FT_platypus.yaml \
